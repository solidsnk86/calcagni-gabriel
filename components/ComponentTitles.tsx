...
export class ComponentTitle {
  static H1({ children, className, style }: TitleProps) {
    return (
      <h1
  ...
  static H2({ children, className, style }: TitleProps) {
    return (
      <h2
  ...
  static H3({ children, className, style }: TitleProps) {
    return (
      <h3
  ...
  static H4({ children, className, style }: TitleProps) {
    return (
      <h3
