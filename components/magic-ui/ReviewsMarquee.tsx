...
export const ReviewCard: React.FC<ReviewsMarqueeProps> = ({
  ...
  return (
    <div
      id={`comment-${id}`}
      className="flex flex-col max-w-xs md:max-w-lg card-comment mx-auto space-y-2 bg-zinc-800/50 border border-zinc-800 rounded-2xl relative my-4 text-pretty"
    >
