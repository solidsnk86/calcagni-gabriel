  ...
  return (
    ...
    >
      <header className="flex gap-4">
        ...
        >
          <span className="pdf absolute -top-2 -right-4 text-[0.6rem] px-1 rounded-full bg-[tomato] opacity-0 group-hover:opacity-100 transition-opacity duration-300 shadow-md shadow-black">
            PDF
          </span>
