...
export function SubmitButton() {
  ...
  return (
    <button
      className="bg-btn-background rounded-md py-2 px-4 text-foreground mb-2 flex items-center justify-center hover:brightness-105 transition-all duration-300 border border-zinc-800/50"
      type="submit"
      disabled={pending}
    >
      <span className="flex items-center">
        {pending ? (
          <>
            <Loader className="mr-2" width={20} height={20} />
          </>
        ) : (
